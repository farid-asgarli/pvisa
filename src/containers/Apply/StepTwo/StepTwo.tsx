...
const StepTwo: typeof Apply.StepTwo = ({
  ...
  return (
    ...
    >
      ...
      />
      {nextPageUrl && <Popups.SuccessfulPayment href={nextPageUrl} />}
      <Banner.Visa
        heading={"Turkey Visa"}
            ...
            >
              ...
              <div className={styles.Group}>
                ...
                <span className={styles.Legend}>
                  Please choose the payment method before clicking the payment
                  button.
                </span>
                ...
                >
                  ...
                  >
                    After clicking <strong>Process to payment</strong> , you
                  ...
                  >
                    After clicking <strong>Process to payment</strong> , you
                    will be redirected to Coinbase Commerce to complete your
                    purchase securely.
                  </Collapse.WithSelect.Item>
                </Collapse.WithSelect.Wrapper>
                <Checkbox className={styles.Checkbox}>
                  Please accept Terms and Privacy to proceed with Payment.
                </Checkbox>
              </div>
              <Divider />
              <Button.Extended
                ...
                onClick={() => addField()}
              >
                {Locales[locale].Buttons_AddAnotherPerson}
              </Button.Extended>
              {additionalFields.map((x) => (
                <div key={x}>
                  ...
                  <Button.Extended
                    ...
                    type="button"
                  >
                    {Locales[locale].Buttons_RemovePerson}
                  </Button.Extended>
                </div>
              ))}
              <div className={styles.Bottom}>
                ...
                >
                  {Locales[locale].Buttons_ContinueToPayment}
                </Button.Primary>
              </div>
            </AntForm>
          </div>
