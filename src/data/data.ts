...
const HomeSteps = [
  {
    ...
    content:
      "Choose prefered Turkey Visa type, fill online visa application form",
    icon: CheckSquareOffset,
  },
  {
    title: "Proceed the Payment",
    content:
      "Our team of experts will scrutinize your visa application before sending it to Turkey authorities for visa processing",
    icon: CreditCard,
  },
  {
    title: "Receive Visa to your email!",
    content:
      "We will email your turkey visa immediately after it is approved. Take a visa printout & fly to Turkey. Bon Voyage!",
    icon: EnvelopeSimple,
  },
];

const UsefulLinks = [
  { content: "Ministry of Foreign Affairs", href: "/" },
  { content: "Ministry of Culture and Tourism", href: "/" },
  { content: "Ministry of Foreign Affairs", href: "/" },
  { content: "Ministry of Culture and Tourism", href: "/" },
];
